<!-- <div class="container">
    <?php echo do_shortcode('[contact-form-7 id="9abc6ea" title="Formulaire de contact 1"]'); ?>
</div> -->
...
<!--
  ...
  ```
-->
<div class="isolate bg-white px-6 py-24 sm:py-32 lg:px-8"  id="contact_us">
    ...
    <div class="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
      ...
      <div class="flex gap-x-4 sm:col-span-2">
        ...
        <label class="text-sm leading-6 text-gray-600" id="switch-1-label">
          ...
          <a href="#" class="font-semibold text-indigo-600">conditions&nbsp;d'utilisation</a>.
        </label>
      </div>
    </div>
    <div class="mt-10">
      <button type="submit" class="block w-full rounded-md bg-indigo-600 px-3.5 py-2.5 text-center text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Rentrons en contact</button>
    </div>
  </form>
</div>
