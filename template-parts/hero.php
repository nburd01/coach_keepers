...
<div class="container-lg">
  <div class="relative isolate overflow-hidden bg-gray-900 sm:py-24">
    <img src="<?php echo get_template_directory_uri(); ?>/resources/images/jeromekeepers/DSC_1524.jpg" alt="Desktop Homepage" alt="" class="absolute  bg-blue-900 opacity-50 inset-0 -z-10 h-full w-full object-cover object-right md:object-center">
      ...
      <div class="w-full flex">
        <div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
          ...
          <!-- <div class="hidden sm:mb-8 sm:flex sm:justify-center">
            <div class="rounded-md bg-indigo-600 bg-opacity-50  shadow-sm px-3.5 py-2.5relative py-1 text-sm leading-6 text-white ring-1 ring-gray-900/10 hover:ring-gray-900/20">
