<div class="container">
<div class="relative isolate overflow-hidden bg-gray-900 sm:py-24 my-4 sm:py-32">
  <img src="<?php echo get_template_directory_uri(); ?>/resources/images/jeromekeepers/DSC_1524.jpg" alt="Desktop Homepage" alt="" class="absolute bg-blue-900 opacity50 inset-0 -z-10 h-full w-full object-cover object-right md:object-center">
  ...
  <div class="mx-auto max-w-7xl px-6 lg:px-8">
    <div class="mx-auto max-w-2xl lg:mx-0">
      <h2 class="text-4xl mt-4 font-bold tracking-tight text-white sm:text-4xl sm:mt-4 ">Work with us</h2>
