...
<section class="bg-white dark:bg-gray-900">
  <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
      ...
      <div class="max-w-screen-md mb-8 lg:mb-16">
          <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">Mon histoire</h2>
          <p class="text-gray-500 sm:text-xl dark:text-gray-400">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Numquam aperiam magnam incidunt minima accusantium saepe quaerat beatae fugiat quas voluptatibus.</p>
      </div>
      <div class="max-w-screen-md mb-8 lg:mb-16">
      <div class="h-full mr-4">
          <img src="<?php echo get_template_directory_uri(); ?>/resources/images/jeromekeepers/DSC_1524.jpg" alt="Jerome Keepers" class="h-auto max-w-full">
        </div>
      </div>
      <div class="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
          <div>
              ...
              <h3 class="mb-2 text-xl font-bold dark:text-white">Joueur Professionnel 2001 - 2012</h3>
              <p class="text-gray-500 dark:text-gray-400">Lorem ipsum dolor sit amet consectetur adipisicing elit. Excepturi explicabo impedit inventore fugiat tempora. Et saepe autem similique quas optio.</p>
          </div>
          <div>
              <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
              ...
              <h3 class="mb-2 text-xl font-bold dark:text-white">International U17 / U18 / Espoirs</h3>
              <p class="text-gray-500 dark:text-gray-400">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quaerat optio saepe totam inventore consequatur natus nihil iure veniam. Ratione, modi?</p>
          </div>
          <div>
              <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
              ...
              <h3 class="mb-2 text-xl font-bold dark:text-white">Responsable Gardien Académie Stade Rennais 2012 - 2023</h3>
              <p class="text-gray-500 dark:text-gray-400">Lorem ipsum dolor sit amet consectetur adipisicing elit. Eum fugiat ratione dignissimos enim nobis fugit quos quidem optio facilis inventore!.</p>
          </div>
          <div>
              <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
              ...
              <h3 class="mb-2 text-xl font-bold dark:text-white">Intervenant Formateur Ligue de Bretagne / FFF</h3>
              <p class="text-gray-500 dark:text-gray-400">Lorem ipsum dolor sit amet consectetur adipisicing elit. Necessitatibus voluptates dolor obcaecati vero impedit beatae porro consectetur non, explicabo aliquid!</p>
          </div>
          <div>
              <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
              ...
              <h3 class="mb-2 text-xl font-bold dark:text-white">Intervenant séminaire entraineur GB ( Apport Garda / Porto)</h3>
              <p class="text-gray-500 dark:text-gray-400">Lorem ipsum dolor sit amet consectetur adipisicing elit. Provident corrupti expedita quo consectetur culpa optio illo voluptas modi velit totam?</p>
          </div>
          <div>
              <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
              ...
              <p class="text-gray-500 dark:text-gray-400">Lorem ipsum dolor sit amet consectetur adipisicing elit. Praesentium nesciunt maiores alias voluptatem voluptatibus corporis nostrum debitis necessitatibus quibusdam! In!</p>
          </div>
      </div>
  </div>
</section>
